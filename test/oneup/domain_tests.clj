...
(deftest integration-tests
         (testing "When adding a user, their password is copied"
                  (println "ADDING " (add-user-command "redbeard" "foo"))
                  (is (:password (user "redbeard")) "foo"))

         (testing "When adding a proposal"
                  (println "PROPOSING " (add-proposal-command "redbeard" [2 2 2 2 2]))
         ...
         (testing "When adding a vote"
                  (println "VOTING " (add-vote-command "blackbeard" "redbeard" 5 3 true))
